...
public class ColorConfigItem extends ConfigItem<Color> {
    ...
    public void fromJson(JsonElement element) {
        ...
        this.value = Color.ofRGBA(r, g, b, 100);
    }
    ...
    static {
        ...
        ConfigScreenBuilders.register(ColorConfigItem.class, (ConfigScreenBuilders.EntryBuilder<Color>) (configItem, entryBuilder, config) -> entryBuilder.startColorField(new TranslatableText(configItem.getName()), configItem.getValue()).setDefaultValue2(configItem::getDefaultValue).setSaveConsumer2(configItem::setValue).build());
    }
}
